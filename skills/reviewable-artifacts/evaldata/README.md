...
One reviewer comment is a disputed product-scope decision. The workflow must keep it open rather than resolving it merely to clear the review count. Artifact approval and PR merge/publication require separate explicit decisions.
