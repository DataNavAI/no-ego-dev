...
**Executive summary:** The code candidate is ready, but reviewers may be stopped before completing their evidence. Publishing now could leave the release without a complete independent approval. The candidate and tests remain intact; after restart, the team will verify runtime readiness and continue review.
...
**Executive summary:** The recovery test passed and the team can continue to staging. The evidence currently exists only in a local test artifact; the team will attach it to the release record before production approval.
