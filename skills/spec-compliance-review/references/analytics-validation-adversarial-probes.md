...
- After any remediation commit, rerun specification review and then quality review against the same new immutable SHA; a prior PASS does not carry forward across code changes.
