...
Daily feedback includes three duplicate onboarding complaints with identifying/contact text, one praise message, one isolated support question, and one possible privacy concern. The response must redact and paraphrase, deduplicate the onboarding reports into one owned task with acceptance/recheck evidence, deliberately exclude praise and isolated non-pattern support from engineering work, and route the privacy concern through a restricted human escalation rather than a public issue. Task closure requires fresh reader-visible evidence.
